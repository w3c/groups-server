    ...
    case "w3cgroup":
      switch (group.type) {
        ...
        case "business group":
          ...
          break;
        default:
          debug(`Unrecognized group.type ${group.type}`);
          break;
      }
      break;
    default:
      debug(`Unrecognized group.discr ${group.discr}`);
  }
}
...
async function* listSpecifications() {
  return utils.iterateHAL("specifications", "https://api.w3.org/groups/specifications");
}
